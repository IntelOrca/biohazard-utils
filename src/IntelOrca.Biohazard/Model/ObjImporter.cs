...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public IModelMesh Import(BioVersion version, string objPath, int numPages, Func<int, Emr.Vector>? translate = null)
        {
            ...
            _textureHeight = 256;
            Import(translate);
            var mesh = new Md2(GetData());
            var meshConverter = new MeshConverter();
            return meshConverter.ConvertMesh(mesh, version, remap: false);
        }
